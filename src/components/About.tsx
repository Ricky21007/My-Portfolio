    ...
    <SectionWrapper id="about" title="About Me">
      <div className="prose prose-lg dark:prose-invert max-w-none">
        ...
        <p>
          ...
          <a href="https://www.linkedin.com/in/tyric-ramplin-39b028326" target="_blank" rel="external nofollow noopener" className="text-primary hover:underline">LinkedIn</a>{' '}
          and{' '}
          <a href="https://github.com/Ricky21007" target="_blank" rel="external noopener" className="text-primary hover:underline">GitHub</a>.
        </p>
      </div>
    </SectionWrapper>
  );
